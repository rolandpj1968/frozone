        ...
        module Runtime
          ...
          OBJECT = RubyClass.new(
            ...
            members: [
              ...
              "// NA-shape direct accessor for the LUT lookup — alloc-free",
              "// alternative for callers that statically know the target",
              "// class. Used by rescue-clause emission (avoids RTTI walk)",
              "// and by non-leaf is_a?/kind_of? lowering (avoids the Array",
              "// wrap for the universal-sig dispatch). Body emitted",
              "// out-of-line alongside mm_is_a_q.",
