        ...
        module Runtime
          ...
          BASIC_OBJECT = RubyClass.new(
            ...
            members: [
              ...
              "virtual BasicObject* m_equal_q(Array* args = &EMPTY_ARGS, Hash* kwargs = nullptr, Proc* block = nullptr) {",
              "  return boxed_bool(this == array_at(args, 0));",
              "}",
              ...
              "virtual BasicObject* m___id__(Array* args = &EMPTY_ARGS, Hash* kwargs = nullptr, Proc* block = nullptr) {",
              ...
              "virtual BasicObject* m_initialize(Array* args = &EMPTY_ARGS, Hash* kwargs = nullptr, Proc* block = nullptr) {",
              "  return this;",
              "}",
          ...
          OBJECT = RubyClass.new(
            ...
            members: [
              ...
              "virtual BasicObject* m_freeze(Array* args = &EMPTY_ARGS, Hash* kwargs = nullptr, Proc* block = nullptr) override {",
              "  return this;",
              "}",
              "virtual BasicObject* m_frozen_q(Array* args = &EMPTY_ARGS, Hash* kwargs = nullptr, Proc* block = nullptr) override {",
              "  return false_instance();",
              "}",
              "// object_id — Kernel#object_id. Same value as __id__.",
              "virtual BasicObject* m_object_id(Array* args = &EMPTY_ARGS, Hash* kwargs = nullptr, Proc* block = nullptr) override {",
              ...
              "virtual BasicObject* m_is_a_q(Array* args = &EMPTY_ARGS, Hash* kwargs = nullptr, Proc* block = nullptr) override;",
              "// send / __send__ — METHOD_VT-based dispatch. Out-of-line body",
              "// emitted by class_emitter (write_send_body) once Array is complete.",
              "virtual BasicObject* m_send(Array* args = &EMPTY_ARGS, Hash* kwargs = nullptr, Proc* block = nullptr) override;",
              "virtual BasicObject* m___send__(Array* args = &EMPTY_ARGS, Hash* kwargs = nullptr, Proc* block = nullptr) override;",
              "virtual BasicObject* m_kind_of_q(Array* args = &EMPTY_ARGS, Hash* kwargs = nullptr, Proc* block = nullptr) override {",
              "  return m_is_a_q(args, kwargs, block);",
              "}",
              "virtual BasicObject* m_instance_of_q(Array* args = &EMPTY_ARGS, Hash* kwargs = nullptr, Proc* block = nullptr) override {",
