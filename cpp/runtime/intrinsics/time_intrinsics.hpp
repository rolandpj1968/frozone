...
inline BasicObject* intrinsic_os_time_now() {
  struct timespec ts;
...
inline BasicObject* intrinsic_os_localtime(BasicObject* sec) {
...
inline BasicObject* intrinsic_os_gmtime(BasicObject* sec) {
  time_t s = static_cast<time_t>(static_cast<Integer*>(sec)->raw_);
  struct tm tm{};
  ::gmtime_r(&s, &tm);
...
inline BasicObject* intrinsic_os_mktime(BasicObject* year, BasicObject* month,
...
inline BasicObject* intrinsic_os_strftime(BasicObject* fmt, BasicObject* sec,
...
inline BasicObject* intrinsic_time_make(BasicObject* sec, BasicObject* nsec,
