...
struct MainObject : Object {
  ...
  virtual BasicObject* m_collect(BasicObject* items = nullptr) {
    return items->m_size();
    return nil_instance();
  }

  virtual BasicObject* m_first_of(BasicObject* items = nullptr) {
    return items->m_aref((new Integer(0LL)));
    return nil_instance();
  }

  void __top_level__() {
    BasicObject* arr = (new Array({(new Integer(10LL)), (new Integer(20LL)), (new Integer(30LL)), (new Integer(40LL)), (new Integer(50LL))}));
    (ruby_puts(this->m_collect(arr)), nil_instance());
    (ruby_puts(this->m_first_of(arr)), nil_instance());
    BasicObject* arr2 = (new Array({(new Integer(99LL)), (new Integer(100LL))}));
    (ruby_puts(this->m_collect(arr2)), nil_instance());
    (ruby_puts(this->m_first_of(arr2)), nil_instance());
  }
};
