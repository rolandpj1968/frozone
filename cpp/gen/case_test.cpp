...
struct MainObject : Object {
  ...
  virtual BasicObject* m_grade(BasicObject* score) {
    return ([&]() -> BasicObject* { auto* _subj = score; if (truthy((new Integer(90LL))->m_case_eq(_subj))) return ((new String("A", 1))); if (truthy((new Integer(80LL))->m_case_eq(_subj))) return ((new String("B", 1))); if (truthy((new Integer(70LL))->m_case_eq(_subj))) return ((new String("C", 1))); if (truthy((new Integer(60LL))->m_case_eq(_subj))) return ((new String("D", 1))); return ((new String("F", 1))); }());
    return nil_instance();
  }

  virtual BasicObject* m_category(BasicObject* n) {
    return ([&]() -> BasicObject* { auto* _subj = n; if (truthy((new Integer(1LL))->m_case_eq(_subj)) || truthy((new Integer(2LL))->m_case_eq(_subj)) || truthy((new Integer(3LL))->m_case_eq(_subj))) return ((new String("low", 3))); if (truthy((new Integer(4LL))->m_case_eq(_subj)) || truthy((new Integer(5LL))->m_case_eq(_subj)) || truthy((new Integer(6LL))->m_case_eq(_subj))) return ((new String("mid", 3))); return ((new String("high", 4))); }());
    return nil_instance();
  }

  virtual BasicObject* m_sign(BasicObject* n) {
    return ([&]() -> BasicObject* { if (truthy(n->m_lt((new Integer(0LL))))) return ((new String("neg", 3))); if (truthy(n->m_eq_q((new Integer(0LL))))) return ((new String("zero", 4))); return ((new String("pos", 3))); }());
    return nil_instance();
  }

  void __top_level__() {
    ruby_puts(this->m_grade((new Integer(90LL))));
    ruby_puts(this->m_grade((new Integer(70LL))));
    ruby_puts(this->m_grade((new Integer(50LL))));
    ruby_puts(this->m_category((new Integer(1LL))));
    ruby_puts(this->m_category((new Integer(5LL))));
    ruby_puts(this->m_category((new Integer(99LL))));
    ruby_puts(this->m_sign((new Integer(-3LL))));
    ruby_puts(this->m_sign((new Integer(0LL))));
    ruby_puts(this->m_sign((new Integer(7LL))));
  }
};
