...
struct BasicObject {
  ...
  virtual BasicObject* m_grade(Array* args, Hash* kwargs = nullptr, Proc* block = nullptr) { return method_missing("grade"); }
  virtual BasicObject* m_category(Array* args, Hash* kwargs = nullptr, Proc* block = nullptr) { return method_missing("category"); }
  virtual BasicObject* m_sign(Array* args, Hash* kwargs = nullptr, Proc* block = nullptr) { return method_missing("sign"); }
...
struct MainObject : Object {
  ...
  virtual BasicObject* m_grade(Array* args, Hash* kwargs = nullptr, Proc* block = nullptr) {
    BasicObject* score = array_at(args, 0);
    Proc* _block = block;
    return ([&]() -> BasicObject* { auto* _subj = score; if (truthy((new Integer(90LL))->m_case_eq((new Array({_subj})), nullptr, nullptr))) return ((new String("A", 1))); if (truthy((new Integer(80LL))->m_case_eq((new Array({_subj})), nullptr, nullptr))) return ((new String("B", 1))); if (truthy((new Integer(70LL))->m_case_eq((new Array({_subj})), nullptr, nullptr))) return ((new String("C", 1))); if (truthy((new Integer(60LL))->m_case_eq((new Array({_subj})), nullptr, nullptr))) return ((new String("D", 1))); return ((new String("F", 1))); }());
    return nil_instance();
  }

  virtual BasicObject* m_category(Array* args, Hash* kwargs = nullptr, Proc* block = nullptr) {
    BasicObject* n = array_at(args, 0);
    Proc* _block = block;
    return ([&]() -> BasicObject* { auto* _subj = n; if (truthy((new Integer(1LL))->m_case_eq((new Array({_subj})), nullptr, nullptr)) || truthy((new Integer(2LL))->m_case_eq((new Array({_subj})), nullptr, nullptr)) || truthy((new Integer(3LL))->m_case_eq((new Array({_subj})), nullptr, nullptr))) return ((new String("low", 3))); if (truthy((new Integer(4LL))->m_case_eq((new Array({_subj})), nullptr, nullptr)) || truthy((new Integer(5LL))->m_case_eq((new Array({_subj})), nullptr, nullptr)) || truthy((new Integer(6LL))->m_case_eq((new Array({_subj})), nullptr, nullptr))) return ((new String("mid", 3))); return ((new String("high", 4))); }());
    return nil_instance();
  }

  virtual BasicObject* m_sign(Array* args, Hash* kwargs = nullptr, Proc* block = nullptr) {
    BasicObject* n = array_at(args, 0);
    Proc* _block = block;
    return ([&]() -> BasicObject* { if (truthy(n->m_lt((new Array({(new Integer(0LL))})), nullptr, nullptr))) return ((new String("neg", 3))); if (truthy(n->m_eq_q((new Array({(new Integer(0LL))})), nullptr, nullptr))) return ((new String("zero", 4))); return ((new String("pos", 3))); }());
    return nil_instance();
  }

  void __top_level__() {
    (ruby_puts(this->m_grade((new Array({(new Integer(90LL))})), nullptr, nullptr)), nil_instance());
    (ruby_puts(this->m_grade((new Array({(new Integer(70LL))})), nullptr, nullptr)), nil_instance());
    (ruby_puts(this->m_grade((new Array({(new Integer(50LL))})), nullptr, nullptr)), nil_instance());
    (ruby_puts(this->m_category((new Array({(new Integer(1LL))})), nullptr, nullptr)), nil_instance());
    (ruby_puts(this->m_category((new Array({(new Integer(5LL))})), nullptr, nullptr)), nil_instance());
    (ruby_puts(this->m_category((new Array({(new Integer(99LL))})), nullptr, nullptr)), nil_instance());
    (ruby_puts(this->m_sign((new Array({(new Integer(-3LL))})), nullptr, nullptr)), nil_instance());
    (ruby_puts(this->m_sign((new Array({(new Integer(0LL))})), nullptr, nullptr)), nil_instance());
    (ruby_puts(this->m_sign((new Array({(new Integer(7LL))})), nullptr, nullptr)), nil_instance());
  }
};
