...
struct BasicObject {
  ...
  virtual BasicObject* m_empty_q() { return method_missing("empty?"); }
...
struct MainObject : Object {
  ...
  void __top_level__() {
    ...
    BasicObject* c = a->m_plus((new String(" ", 1)))->m_plus(b);
    ruby_puts(c);
    a->m_lshift((new String(" there", 6)));
    ruby_puts(a);
    ruby_puts((new String("abc", 3))->m_length());
    ruby_puts((new String("abc", 3))->m_bytesize());
    ruby_puts((new String("abc", 3))->m_eq_q((new String("abc", 3))));
    ruby_puts((new String("abc", 3))->m_eq_q((new String("abd", 3))));
    ruby_puts((new String("abc", 3))->m_lt((new String("abd", 3))));
    ruby_puts((new String("hello", 5))->m_aref((new Integer(0LL))));
    ruby_puts((new String("hello", 5))->m_aref((new Integer(-1LL))));
    BasicObject* h = (new Hash({{(new String("foo", 3)), (new Integer(1LL))}, {(new String("bar", 3)), (new Integer(2LL))}}));
    ruby_puts(h->m_aref((new String("foo", 3))));
    ruby_puts(h->m_aref((new String("bar", 3))));
    ruby_puts((new String("", 0))->m_empty_q());
    ruby_puts((new String("x", 1))->m_empty_q());
  }
};
