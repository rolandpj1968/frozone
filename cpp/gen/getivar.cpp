...
extern TheClass_eigenclass TheClass_CLASS;
...
struct BasicObject {
  ...
  virtual BasicObject* m_get_value_loop(Array* args, Hash* kwargs = nullptr, Proc* block = nullptr) { return method_missing("get_value_loop"); }
...
struct TheClass : Object {
  using Object::Object;
  const char* ruby_class_name() const override { return "TheClass"; }
  BasicObject* iv_v0 = nullptr;
  BasicObject* iv_v1 = nullptr;
  BasicObject* iv_v2 = nullptr;
  BasicObject* iv_levar = nullptr;
  TheClass();
  template<class... __Ts__, std::enable_if_t<(... && std::is_pointer_v<__Ts__>), int> = 0> TheClass(__Ts__...) {}
  virtual BasicObject* m_get_value_loop(Array* args, Hash* kwargs = nullptr, Proc* block = nullptr) override;
};
...
struct TheClass_eigenclass : Class {
  using Class::Class;
  const char* ruby_class_name() const override { return "TheClass"; }
  template<class... __Ts__, std::enable_if_t<(... && std::is_pointer_v<__Ts__>), int> = 0> TheClass_eigenclass(__Ts__...) {}
};
...
inline TheClass_eigenclass TheClass_CLASS;
...
inline TheClass::TheClass() {
  (this->iv_v0 = (new Integer(1LL)));
  (this->iv_v1 = (new Integer(2LL)));
  (this->iv_v2 = (new Integer(3LL)));
  (this->iv_levar = (new Integer(1LL)));
}

inline BasicObject* TheClass::m_get_value_loop(Array* args, Hash* kwargs, Proc* block) {
  Proc* _block = block;
  BasicObject* sum = nil_instance();
  BasicObject* i = nil_instance();
  sum = (new Integer(0LL));
  i = (new Integer(0LL));
  while (truthy(i->m_lt((new Array({(new Integer(10000LL))})), nullptr, nullptr))) {
    sum = sum->m_plus((new Array({this->iv_levar})), nullptr, nullptr);
    sum = sum->m_plus((new Array({this->iv_levar})), nullptr, nullptr);
    sum = sum->m_plus((new Array({this->iv_levar})), nullptr, nullptr);
    sum = sum->m_plus((new Array({this->iv_levar})), nullptr, nullptr);
    sum = sum->m_plus((new Array({this->iv_levar})), nullptr, nullptr);
...
inline BasicObject* k_OBJ() {
  static BasicObject* val = new TheClass(); return val;
}
...
struct MainObject : Object {
  ...
  void __top_level__() {
    BasicObject* last = (new Integer(0LL));
    for (int64_t ___i_raw__ = 0; ___i_raw__ < 300LL; ___i_raw__++) {
      BasicObject* _i = new Integer(___i_raw__);
      last = k_OBJ()->m_get_value_loop((new Array({})), nullptr, nullptr);
    }
    (ruby_puts(last), nil_instance());
  }
};
