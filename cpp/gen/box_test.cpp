...
struct Box : Object {
  ...
  Box(BasicObject* v);
  template<class... __Ts__, std::enable_if_t<(... && std::is_pointer_v<__Ts__>), int> = 0> Box(__Ts__...) {}
  virtual BasicObject* m_value(Array* args, Hash* kwargs = nullptr, Proc* block = nullptr) override;
  virtual BasicObject* m_doubled(Array* args, Hash* kwargs = nullptr, Proc* block = nullptr) override;
};
...
struct Box_eigenclass : Class {
  using Class::Class;
  const char* ruby_class_name() const override { return "Box"; }
  template<class... __Ts__, std::enable_if_t<(... && std::is_pointer_v<__Ts__>), int> = 0> Box_eigenclass(__Ts__...) {}
};
...
inline Box::Box(BasicObject* v) {
  (this->iv_v = v);
}

inline BasicObject* Box::m_value(Array* args, Hash* kwargs, Proc* block) {
  Proc* _block = block;
  return this->iv_v;
  return nil_instance();
}

inline BasicObject* Box::m_doubled(Array* args, Hash* kwargs, Proc* block) {
  Proc* _block = block;
  return this->iv_v->m_plus((new Array({this->iv_v})), nullptr, nullptr);
  return nil_instance();
}
...
struct MainObject : Object {
  ...
  void __top_level__() {
    BasicObject* b = (new Box(static_cast<BasicObject*>((new Integer(42LL)))));
    (ruby_puts(b->m_value((new Array({})), nullptr, nullptr)), nil_instance());
    (ruby_puts(b->m_doubled((new Array({})), nullptr, nullptr)), nil_instance());
  }
};
