...
static auto sd_genmat() {
  RubyArray_I64 mr = ({ auto _arr = RubyArray_F64(324LL); for (int64_t _ai = 0; _ai < 324LL; _ai++) { _arr[_ai] = RubyArray_I64(0); } _arr; });
  ...
  return ({ auto _a = RubyArray_I64(2); _a[0] = mr; _a[1] = mc; _a; });
}
...
static auto sd_update_forward(auto mr, auto mc, auto sr, auto sc, auto r) {
  ...
  return ({ auto _a = RubyArray_I64(2); _a[0] = min; _a[1] = min_c; _a; });
}

static int64_t sd_update_reverse(auto mr, auto mc, auto sr, auto sc, auto r) {
  int64_t c2 = 0LL;
  while ((c2 < 4LL)) {
    sc[mc[r][c2]] -= 128LL;
    c2 = (c2 + 1LL);
...
static int64_t sd_solve(auto mr, auto mc, auto s) {
