...
struct BasicObject {
  ...
  virtual BasicObject* m_fib(Array* args, Hash* kwargs = nullptr, Proc* block = nullptr) { return method_missing("fib"); }
...
struct MainObject : Object {
  ...
  virtual BasicObject* m_fib(Array* args, Hash* kwargs = nullptr, Proc* block = nullptr) {
    BasicObject* n = array_at(args, 0);
    Proc* _block = block;
    if (truthy(n->m_lt((new Array({(new Integer(2LL))})), nullptr, nullptr))) {
      return n;
    }
    return this->m_fib((new Array({n->m_minus((new Array({(new Integer(1LL))})), nullptr, nullptr)})), nullptr, nullptr)->m_plus((new Array({this->m_fib((new Array({n->m_minus((new Array({(new Integer(2LL))})), nullptr, nullptr)})), nullptr, nullptr)})), nullptr, nullptr);
    return nil_instance();
  }

  void __top_level__() {
    BasicObject* total = (new Integer(0LL));
    for (int64_t ___i_raw__ = 0; ___i_raw__ < 3LL; ___i_raw__++) {
      BasicObject* _i = new Integer(___i_raw__);
      total = total->m_plus((new Array({this->m_fib((new Array({(new Integer(35LL))})), nullptr, nullptr)})), nullptr, nullptr);
    }
