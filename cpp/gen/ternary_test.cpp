...
struct MainObject : Object {
  ...
  virtual BasicObject* m_classify(Array* args, Hash* kwargs = nullptr, Proc* block = nullptr) {
    BasicObject* x = array_at(args, 0);
    Proc* _block = block;
    return (truthy(x->m_gt((new Array({(new Integer(100LL))})), nullptr, nullptr)) ? (((new String("huge", 4)))) : ((truthy(x->m_gt((new Array({(new Integer(10LL))})), nullptr, nullptr)) ? (((new String("big", 3)))) : (((new String("small", 5)))))));
    return nil_instance();
  }

  void __top_level__() {
    BasicObject* n = (new Integer(5LL));
    (ruby_puts((truthy(n->m_lt((new Array({(new Integer(10LL))})), nullptr, nullptr)) ? (((new String("small", 5)))) : (((new String("big", 3)))))), nil_instance());
    (ruby_puts((truthy(n->m_gt((new Array({(new Integer(10LL))})), nullptr, nullptr)) ? (((new String("big", 3)))) : (((new String("small", 5)))))), nil_instance());
    BasicObject* sign = (truthy(n->m_lt((new Array({(new Integer(0LL))})), nullptr, nullptr)) ? (((new String("neg", 3)))) : (((new String("pos", 3)))));
    (ruby_puts(sign), nil_instance());
    BasicObject* result = (truthy(n->m_gt((new Array({(new Integer(0LL))})), nullptr, nullptr)) ? ((n->m_plus((new Array({(new Integer(100LL))})), nullptr, nullptr))) : (((new Integer(0LL)))));
    (ruby_puts(result), nil_instance());
    (ruby_puts(this->m_classify((new Array({(new Integer(5LL))})), nullptr, nullptr)), nil_instance());
    (ruby_puts(this->m_classify((new Array({(new Integer(50LL))})), nullptr, nullptr)), nil_instance());
    (ruby_puts(this->m_classify((new Array({(new Integer(500LL))})), nullptr, nullptr)), nil_instance());
  }
};
