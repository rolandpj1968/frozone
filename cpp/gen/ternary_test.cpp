...
struct BasicObject {
  ...
  virtual BasicObject* m_gt(BasicObject*) { return method_missing(">"); }
...
struct MainObject : Object {
  ...
  virtual BasicObject* m_classify(BasicObject* x) {
    return (truthy(x->m_gt((new Integer(100LL)))) ? (((new String("huge", 4)))) : ((truthy(x->m_gt((new Integer(10LL)))) ? (((new String("big", 3)))) : (((new String("small", 5)))))));
    return nil_instance();
  }

  void __top_level__() {
    BasicObject* n = (new Integer(5LL));
    ruby_puts((truthy(n->m_lt((new Integer(10LL)))) ? (((new String("small", 5)))) : (((new String("big", 3))))));
    ruby_puts((truthy(n->m_gt((new Integer(10LL)))) ? (((new String("big", 3)))) : (((new String("small", 5))))));
    BasicObject* sign = (truthy(n->m_lt((new Integer(0LL)))) ? (((new String("neg", 3)))) : (((new String("pos", 3)))));
    ruby_puts(sign);
    BasicObject* result = (truthy(n->m_gt((new Integer(0LL)))) ? ((n->m_plus((new Integer(100LL))))) : (((new Integer(0LL)))));
    ruby_puts(result);
    ruby_puts(this->m_classify((new Integer(5LL))));
    ruby_puts(this->m_classify((new Integer(50LL))));
    ruby_puts(this->m_classify((new Integer(500LL))));
  }
};
