...
struct MainObject : Object {
  ...
  void __top_level__() {
    ...
    (ruby_puts(a->m_size((new Array({})), nullptr, nullptr)), nil_instance());
    (ruby_puts(a->m_aref((new Array({(new Integer(0LL))})), nullptr, nullptr)), nil_instance());
    (ruby_puts(a->m_aref((new Array({(new Integer(2LL))})), nullptr, nullptr)), nil_instance());
    (ruby_puts(a->m_aref((new Array({(new Integer(-1LL))})), nullptr, nullptr)), nil_instance());
    a->m_push((new Array({(new Integer(99LL))})), nullptr, nullptr);
    (ruby_puts(a->m_size((new Array({})), nullptr, nullptr)), nil_instance());
    (ruby_puts(a->m_aref((new Array({(new Integer(5LL))})), nullptr, nullptr)), nil_instance());
    (ruby_puts(a->m_first((new Array({})), nullptr, nullptr)), nil_instance());
    (ruby_puts(a->m_last((new Array({})), nullptr, nullptr)), nil_instance());
  }
};
