...
struct BasicObject {
  ...
  virtual BasicObject* m_thrice(Array* args, Hash* kwargs = nullptr, Proc* block = nullptr) { return method_missing("thrice"); }
  virtual BasicObject* m_maybe_yield(Array* args, Hash* kwargs = nullptr, Proc* block = nullptr) { return method_missing("maybe_yield"); }
...
struct MainObject : Object {
  ...
  virtual BasicObject* m_thrice(Array* args, Hash* kwargs = nullptr, Proc* block = nullptr) {
    Proc* _block = block;
    _block->m_call((new Array({(new Integer(1LL))})), nullptr, nullptr);
    _block->m_call((new Array({(new Integer(2LL))})), nullptr, nullptr);
    return _block->m_call((new Array({(new Integer(3LL))})), nullptr, nullptr);
    return nil_instance();
  }

  virtual BasicObject* m_maybe_yield(Array* args, Hash* kwargs = nullptr, Proc* block = nullptr) {
    BasicObject* x = array_at(args, 0);
    Proc* _block = block;
    return _block->m_call((new Array({x})), nullptr, nullptr);
    return nil_instance();
  }

  void __top_level__() {
    this->m_thrice((new Array({})), nullptr, (new Proc([&](BasicObject* arg) -> BasicObject* { BasicObject* n = arg; return (ruby_puts(n), nil_instance()); })));
    this->m_maybe_yield((new Array({(new Integer(42LL))})), nullptr, (new Proc([&](BasicObject* arg) -> BasicObject* { BasicObject* x = arg; return (ruby_puts(x), nil_instance()); })));
    BasicObject* total = (new Integer(0LL));
    this->m_thrice((new Array({})), nullptr, (new Proc([&](BasicObject* arg) -> BasicObject* { BasicObject* n = arg; return (total = total->m_plus((new Array({n})), nullptr, nullptr)); })));
    (ruby_puts(total), nil_instance());
  }
};
