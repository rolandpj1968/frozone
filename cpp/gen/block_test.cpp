...
struct BasicObject {
  ...
  virtual BasicObject* m_call(BasicObject*) { return method_missing("call"); }
};
...
struct Proc : Object {
  ...
  BasicObject* m_call(BasicObject* arg) override {
    return fn_(arg);
  }
};
...
struct MainObject : Object {
  ...
  virtual BasicObject* m_run_benchmark(BasicObject* __anon_rest__ = nullptr, Proc* __anon_block__ = nullptr) {
    return nil_instance();
    return nil_instance();
  }

  virtual BasicObject* m_thrice(Proc* _block = nullptr) {
    _block->m_call((new Integer(1LL)));
    _block->m_call((new Integer(2LL)));
    return _block->m_call((new Integer(3LL)));
    return nil_instance();
  }

  virtual BasicObject* m_maybe_yield(BasicObject* x, Proc* _block = nullptr) {
    return _block->m_call(x);
    return nil_instance();
  }

  void __top_level__() {
    this->m_thrice((new Proc([&](BasicObject* arg) -> BasicObject* { BasicObject* n = arg; return (ruby_puts(n), nil_instance()); })));
    this->m_maybe_yield((new Integer(42LL)), (new Proc([&](BasicObject* arg) -> BasicObject* { BasicObject* x = arg; return (ruby_puts(x), nil_instance()); })));
    BasicObject* total = (new Integer(0LL));
    this->m_thrice((new Proc([&](BasicObject* arg) -> BasicObject* { BasicObject* n = arg; return (total = total->m_plus(n)); })));
