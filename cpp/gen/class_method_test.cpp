...
extern Counter_eigenclass Counter_CLASS;
...
struct BasicObject {
  ...
  virtual BasicObject* m_create_with(Array* args, Hash* kwargs = nullptr, Proc* block = nullptr) { return method_missing("create_with"); }
  virtual BasicObject* m_value(Array* args, Hash* kwargs = nullptr, Proc* block = nullptr) { return method_missing("value"); }
  virtual BasicObject* m_zero(Array* args, Hash* kwargs = nullptr, Proc* block = nullptr) { return method_missing("zero"); }
...
struct Counter : Object {
  ...
  template<class... __Ts__, std::enable_if_t<(... && std::is_pointer_v<__Ts__>), int> = 0> Counter(__Ts__...) {}
  virtual BasicObject* m_value(Array* args, Hash* kwargs = nullptr, Proc* block = nullptr) override;
};
...
struct Counter_eigenclass : Class {
  using Class::Class;
  const char* ruby_class_name() const override { return "Counter"; }
  template<class... __Ts__, std::enable_if_t<(... && std::is_pointer_v<__Ts__>), int> = 0> Counter_eigenclass(__Ts__...) {}
  virtual BasicObject* m_create_with(Array* args, Hash* kwargs = nullptr, Proc* block = nullptr) override;
  virtual BasicObject* m_zero(Array* args, Hash* kwargs = nullptr, Proc* block = nullptr) override;
};
...
inline Counter::Counter(BasicObject* n) {
  (this->iv_n = n);
}

inline BasicObject* Counter::m_value(Array* args, Hash* kwargs, Proc* block) {
  Proc* _block = block;
  return this->iv_n;
  return nil_instance();
}
...
inline BasicObject* Counter_eigenclass::m_create_with(Array* args, Hash* kwargs, Proc* block) {
  BasicObject* n = array_at(args, 0);
  Proc* _block = block;
  return (new Counter(static_cast<BasicObject*>(n)));
  return nil_instance();
}

inline BasicObject* Counter_eigenclass::m_zero(Array* args, Hash* kwargs, Proc* block) {
  Proc* _block = block;
  return (new Counter(static_cast<BasicObject*>((new Integer(0LL)))));
  return nil_instance();
}
...
struct MainObject : Object {
  ...
  void __top_level__() {
    BasicObject* c1 = (&Counter_CLASS)->m_create_with((new Array({(new Integer(42LL))})), nullptr, nullptr);
    (ruby_puts(c1->m_value((new Array({})), nullptr, nullptr)), nil_instance());
    BasicObject* c2 = (&Counter_CLASS)->m_zero((new Array({})), nullptr, nullptr);
    (ruby_puts(c2->m_value((new Array({})), nullptr, nullptr)), nil_instance());
    BasicObject* klass = (&Counter_CLASS);
    BasicObject* c3 = klass->m_create_with((new Array({(new Integer(99LL))})), nullptr, nullptr);
    (ruby_puts(c3->m_value((new Array({})), nullptr, nullptr)), nil_instance());
  }
};
