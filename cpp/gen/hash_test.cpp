...
struct BasicObject {
  ...
  virtual BasicObject* m_has_key_q(Array* args, Hash* kwargs = nullptr, Proc* block = nullptr) { return method_missing("has_key?"); }
...
struct MainObject : Object {
  ...
  void __top_level__() {
    ...
    (ruby_puts(h->m_aref((new Array({intern("foo")})), nullptr, nullptr)), nil_instance());
    (ruby_puts(h->m_aref((new Array({intern("bar")})), nullptr, nullptr)), nil_instance());
    (ruby_puts(h->m_aref((new Array({intern("baz")})), nullptr, nullptr)), nil_instance());
    (ruby_puts(h->m_size((new Array({})), nullptr, nullptr)), nil_instance());
    ...
    (ruby_puts(g->m_aref((new Array({(new Integer(1LL))})), nullptr, nullptr)), nil_instance());
    (ruby_puts(g->m_aref((new Array({(new Integer(2LL))})), nullptr, nullptr)), nil_instance());
    (ruby_puts(g->m_aref((new Array({(new Integer(3LL))})), nullptr, nullptr)), nil_instance());
    (ruby_puts(g->m_size((new Array({})), nullptr, nullptr)), nil_instance());
    h->m_aset((new Array({intern("qux"), (new Integer(99LL))})), nullptr, nullptr);
    (ruby_puts(h->m_aref((new Array({intern("qux")})), nullptr, nullptr)), nil_instance());
    (ruby_puts(h->m_size((new Array({})), nullptr, nullptr)), nil_instance());
    (ruby_puts(h->m_has_key_q((new Array({intern("foo")})), nullptr, nullptr)), nil_instance());
    (ruby_puts(h->m_has_key_q((new Array({intern("nonexistent")})), nullptr, nullptr)), nil_instance());
  }
};
