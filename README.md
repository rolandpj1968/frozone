...
22 compiled benchmarks including blurhash (first real application — image hashing with nested modules, class methods, Math.cos, 3D arrays). Numeric/accessor/tree benchmarks are 3.7–95× faster than YJIT.
