...
Ruby_EXPENSIVE = RubyRange.new(RubyInteger.new(0_i64), RubyInteger.new(10_i64), true).map() { |i| (i * RubyInteger.new(2_i64)) }
STDOUT.puts(Ruby_EXPENSIVE.length.to_s); RUBY_NIL
