...
Ruby_Sym_0 = RubySymbol.from("left")
Ruby_Sym_1 = RubySymbol.from("right")
...
def add(*, left : RubyObject, right : RubyObject)
  (left + right)
end
...
last = 0_i64
3_i64.times { 5000_i64.times { |i| add(left: RubyInteger.new(1_i64), right: RubyInteger.new(0_i64))
add(left: RubyInteger.new(1_i64), right: RubyInteger.new(1_i64))
add(left: RubyInteger.new(1_i64), right: RubyInteger.new(2_i64))
add(left: RubyInteger.new(1_i64), right: RubyInteger.new(3_i64))
last = add(left: RubyInteger.new(1_i64), right: RubyInteger.new(4_i64)).to_i64 } }
