...
int main() {
  int64_t t = /* UNSUPPORTED: ConstantPath */.new(/* UNSUPPORTED: SymbolLiteral */);
  printf("%.9f\n", (double)(t.kind().to_s()));
  printf("%.9f\n", (double)(t.i64?().to_s()));
  printf("%.9f\n", (double)(t.numeric?().to_s()));
  int64_t t2 = /* UNSUPPORTED: ConstantPath */.new(/* UNSUPPORTED: SymbolLiteral */);
  printf("%.9f\n", (double)(t2.f64?().to_s()));
  printf("%.9f\n", (double)(t2.to_crystal()));
  return 0;
}
